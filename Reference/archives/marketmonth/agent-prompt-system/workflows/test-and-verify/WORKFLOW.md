...
description: Choose and run appropriate verification; label evidence honestly.
categories:
  - testing
  - verification
tags:
...
do_not_use_when:
  - No code or config change occurred and user only asked a question
compatible_with:
  - implement-feature
...
Choose and run appropriate verification; label evidence honestly.
