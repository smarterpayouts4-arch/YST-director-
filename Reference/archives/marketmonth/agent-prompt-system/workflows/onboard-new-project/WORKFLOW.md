...
description: Fill or refresh project-context after copying APS into a repository.
categories:
  - onboarding
  - docs
tags:
...
risk_levels:
  ...
  - medium
use_when:
  - APS was copied into a new repo
  - project-context is stale or scaffolded
do_not_use_when:
  - Implementing a product feature in an already-onboarded repo
compatible_with:
...
Fill or refresh project-context after copying APS into a repository.
