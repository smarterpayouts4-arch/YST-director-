...
version: 1.0.0
title: Plan Feature
description: Clarify scope, options, and a task spec before implementation.
categories:
  - planning
tags:
  - spec
...
risk_levels:
  ...
  - high
use_when:
  - Multi-file feature with open decisions
  - User wants a plan before coding
do_not_use_when:
  - User explicitly wants immediate tiny edit
  - Bug reproduction is the only need
compatible_with:
...
Clarify scope, options, and a task spec before implementation.
