...
description: Ship surgical changes within an approved task specification.
categories:
  - implementation
tags:
  - feature
...
risk_levels:
  ...
  - high
use_when:
  - Scope and acceptance criteria are clear enough to code
  - Implementing after plan-feature
do_not_use_when:
  - Requirements are still ambiguous
  - User asked for investigation only
compatible_with:
  - plan-feature
  - test-and-verify
...
Ship surgical changes within an approved task specification.
