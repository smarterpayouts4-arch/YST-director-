---
id: improve-seo-and-llm-readiness
version: 1.0.0
title: Improve SEO and LLM Readiness
description: Improve crawlability, metadata parity, and AI-readable surfaces without inventing claims.
categories:
  - seo
  - content
tags:
...
risk_levels:
  ...
  - high
use_when:
  - Google/AI discoverability improvements
  - Metadata, structured data, or llms surfaces
do_not_use_when:
  - Pure visual polish with no indexing angle
  - Deploy-only request
compatible_with:
...
Improve crawlability, metadata parity, and AI-readable surfaces without inventing claims.
