...
description: Check secrets, authz, PII handling, and unsafe logging before or after changes.
categories:
  - security
tags:
  - secrets
...
risk_levels:
  ...
  - high
use_when:
  - Auth, secrets, PII, or logging changes
  - Security-sensitive review requested
do_not_use_when:
  - Cosmetic UI-only work with no data exposure
compatible_with:
...
Check secrets, authz, PII handling, and unsafe logging before or after changes.
