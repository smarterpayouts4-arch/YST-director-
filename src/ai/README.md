...
| `repair-invalid-output` (nested) | [`structured-openai.ts`](../features/research-prompt-builder/services/structured-openai.ts) | — | [`repair-output.ts`](../features/research-prompt-builder/prompts/repair-output.ts) | parent schema | [`repair-output-contract.test.ts`](../../tests/evals/repair-output-contract.test.ts) |
